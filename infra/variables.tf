# Espelho das variáveis em infra/envs/*/variables.tf (Terraform apply: use o diretório env como root).
# Overrides opcionais; vazio = usa parâmetros SSM (ver ssm.tf em cada env).
variable "smtp_host" {
  type        = string
  default     = ""
  sensitive   = true
